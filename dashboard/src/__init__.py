...
def get_ifc_doors(debug_type, excludes=[], includes=[]):
    get_elements_doors = GetElements(ifc_type='IfcDoor', debug=debug_type, properties_options={'excludes': excludes, 'includes': includes})
...
def get_ifc_railling(debug_type, excludes=[], includes=[]):
    get_elements_railling = GetElements(ifc_type='IfcRailling', debug=debug_type, properties_options={'excludes': excludes, 'includes': includes})
...
def get_ifc_roof(debug_type, excludes=[], includes=[]):
    get_elements_roof = GetElements(ifc_type='IfcRoof', debug=debug_type, properties_options={'excludes': excludes, 'includes': includes})
...
def get_ifc_slab(debug_type, excludes=[], includes=[]):
    get_elements_slab = GetElements(ifc_type='IfcSlab', debug=debug_type, properties_options={'excludes': excludes, 'includes': includes})
...
def get_ifc_wall(debug_type, excludes=[], includes=[]):
    get_elements_wall = GetElements(ifc_type='IfcWall', debug=debug_type, properties_options={'excludes': excludes, 'includes': includes})
