...
if __name__ == '__main__':
    if 'dataset' in globals():
        get_elements = GetElements(dataset=dataset, ifc_type='IfcWallStandardCase')
    else:
        get_elements = GetElements(ifc_type='IfcWallStandardCase', debug='soft')
    print("Getting elements from API...")
    IfcWallStandardCases = get_elements.run()
    print("Finished")