...
if __name__ == '__main__':
    if 'dataset' in globals():
        get_elements = GetElements(dataset=dataset, ifc_type='IfcCurtainWall')
    else:
        get_elements = GetElements(ifc_type='IfcCurtainWall', debug='soft')
    print("Getting elements from API...")
    IfcCurtainWalls = get_elements.run()
    print("Finished")