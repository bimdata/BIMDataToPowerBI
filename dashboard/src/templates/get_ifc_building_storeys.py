...
if __name__ == '__main__':
    if 'dataset' in globals():
        get_elements = GetElements(dataset=dataset, ifc_type='IfcBuildingStorey')
    else:
        get_elements = GetElements(ifc_type='IfcBuildingStorey', debug='soft')
    print("Getting elements from API...")
    IfcBuildingStoreys = get_elements.run()
    print("Finished")